...
export const Textarea = ({
  ...
  return (
    <textarea
      ...
      name={name}
      value={value}
      className={`block w-full h-40 mt-2 px-3 py-2 text-gray-600  border-b border-gray-100 focus:border-primary transition outline-none hover:border-gray-300 ${className}`}
      placeholder={placeholder}
      onChange={onChange}
    />
  );
