  ...
  try {
    ...
    if (!description && !status) {
      return res
        ...
        .json({
          status: false,
          msg: "Description or status of task not provided",
        });
    }
    ...
    // Update the task fields that are provided in the request body
    const updatedFields = {};
    ...
    task = await Task.findByIdAndUpdate(req.params.taskId, updatedFields, {
      new: true,
    });
